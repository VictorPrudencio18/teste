...
export const GEMINI_TEXT_MODEL = 'models/gemini-2.0-flash-lite';

export const WeekDays = [
  'Domingo', 'Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sábado'
];

// SVG Icons (Heroicons examples)
...
export const AcademicCapIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.438 60.438 0 00-.491 6.347A48.62 48.62 0 0112 20.25c2.472 0 4.796-.646 6.824-1.756a60.439 60.439 0 00-.49-6.347m-5.482 4.756A48.636 48.636 0 0012 14.25c-2.472 0-4.796.646-6.824 1.756L3.75 14.25M3.75 14.25a2.25 2.25 0 012.25-2.25h12a2.25 2.25 0 012.25 2.25m-16.5 0L12 16.5m-8.25-2.25v-6a2.25 2.25 0 012.25-2.25h12a2.25 2.25 0 012.25 2.25v6" />
  </svg>
);

export const LightBulbIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.354a15.055 15.055 0 01-4.5 0M12 3c2.667 0 5.167 1.009 7.071 2.929S21.929 9.333 21.929 12c0 .849-.117 1.67-.337 2.454M4.409 14.454A9.007 9.007 0 014.071 12c0-2.667 1.009-5.167 2.929-7.071S10.333 3 12 3m0 18c2.013 0 3.895-.628 5.443-1.732M6.557 19.268A10.432 10.432 0 0112 18z" />
  </svg>
);
...
export const XCircleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6 text-red-500" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const SparklesIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
    <path fillRule="evenodd" d="M10.868 2.884c-.321-.772-1.415-.772-1.736 0l-1.83 4.401-4.753.39-3.423 3.252.935 4.847 4.003 2.691 2.408-4.141.002-.002.002.002 2.408 4.141 4.003-2.691.935-4.847-3.423-3.252-4.753-.39-1.83-4.401zM11.632 10.17l1.14-2.748 3.017-.246-2.176 2.07.521 3.078-2.67 1.794-1.498-2.583-.002.001-.002-.001-1.498 2.583-2.67-1.794.521-3.078-2.176-2.07 3.017-.246 1.14 2.748L10 7.499l1.632 2.671z" clipRule="evenodd" />
  </svg>
);
...
export const RectangleStackIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M6.429 9.75L2.25 12l4.179 2.25m0-4.5l5.571 3 5.571-3m-11.142 0L2.25 7.5 12 2.25l9.75 5.25-3.75 2.25M12 15l2.25 1.5L12 18l-2.25-1.5L12 15z" />
  </svg>
);
...
export const ChartPieIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6a7.5 7.5 0 100 15 7.5 7.5 0 000-15zm0 0V3m0 3v.01M10.5 12H3m7.5 0h7.5m-7.5 0V9m0 3v3m0-15a15.002 15.002 0 00-14.122 12.035M10.5 3a15.002 15.002 0 0110.607 4.393" />
  </svg>
);
...
export const RefreshIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => ( // Same as ArrowPathIcon, but can be renamed for semantic clarity if desired
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0l3.181 3.183a8.25 8.25 0 0013.803-3.7M4.031 9.865a8.25 8.25 0 0113.803-3.7l3.181 3.182m0-4.991v4.99" />
  </svg>
);
...
// Novos ícones para melhorar o design dos resumos
...
export const ShieldCheckIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.333 9-6.03 9-11.623A11.99 11.99 0 0020.402 6 11.959 11.959 0 0112 2.75z" />
  </svg>
);
