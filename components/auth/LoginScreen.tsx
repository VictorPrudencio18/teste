...
export const LoginScreen: React.FC<LoginScreenProps> = ({ onLogin, onNavigateToRegister, isLoading, error }) => {
    ...
    <div className="min-h-[calc(100vh-250px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <Card className="max-w-md w-full" title="">
        ...
        <p className="mt-8 text-center text-sm text-slate-600">
          Não tem uma conta?{' '}
          <Button variant="link" onClick={onNavigateToRegister} disabled={isLoading} className="font-medium text-sky-600 hover:text-sky-700">
            Crie uma agora
          </Button>
        </p>
      </Card>
